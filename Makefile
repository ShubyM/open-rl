...
UNIT_TESTS ?= tests.test_session_lifecycle tests.test_proto_codec tests.test_trainer_worker tests.test_fft_batch_failure tests.test_api_server_paths tests.test_accel_timeslicer tests.test_training_requests_processor tests.test_worker_manager tests.test_scheduler_worker_manager tests.test_estimator tests.test_redis_store tests.test_cluster_eval_script tests.test_weight_delta tests.test_delta_weight_transfer_engine tests.test_sampler_weight_rotation tests.test_commands
