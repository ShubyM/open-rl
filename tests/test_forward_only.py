...
class ForwardOnlyTest(unittest.TestCase):
  def setUp(self) -> None:
    ...
    self.session = TrainingSession(self.model, list(self.model.parameters()))
  ...
  def test_forward_only_leaves_no_gradients(self) -> None:
    result = self.session.forward_backward(_datums(), "cross_entropy", forward_only=True)
  ...
  def test_training_pass_still_accumulates(self) -> None:
    self.session.forward_backward(_datums(), "cross_entropy")
  ...
  def test_forward_only_after_training_does_not_change_gradients(self) -> None:
    ...
    self.session.forward_backward(_datums(), "cross_entropy", forward_only=True)
  ...
  def test_forward_only_returns_the_same_logprobs_as_a_training_pass(self) -> None:
    ...
    forward_only = self.session.forward_backward(_datums(), "cross_entropy", forward_only=True)
    trained = self.session.forward_backward(_datums(), "cross_entropy")
