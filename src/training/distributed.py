...
def default_device() -> torch.device:
  """This rank's accelerator: its CUDA device under torchrun, else MPS or CPU.

  LOCAL_RANK is set by the CUDA launcher (torchrun), so it only indexes GPUs;
  a non-CUDA backend ignores it.
  """
