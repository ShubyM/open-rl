  ...
  snapshot = {
    ...
    "kubernetes": {
      ...
      "observation": {
        ...
        "collection_ms": 18.4,
        "components_ms": {"pods": 8.1, "nodes": 3.2, "events": 4.6, "scheduler": 5.4, "rollouts": 6.1, "metrics": 2.8},
        "source": "live",
        "age_seconds": 0,
      },
      "metrics": {
    ...
    "gateway": {
      ...
      "http": {
        ...
        "groups": {
          "application": {
            "requests": 124,
            "requests_per_second": 0.4133,
            "in_window_server_errors": 2,
            "in_window_client_errors": 1,
            "server_error_rate": 0.0161,
            "p50_latency_seconds": 0.083,
            "p95_latency_seconds": 0.42,
            "max_latency_seconds": 3.8,
          },
          "background": {
            "requests": 84,
            "requests_per_second": 0.28,
            "in_window_server_errors": 0,
            "in_window_client_errors": 0,
            "server_error_rate": 0.0,
            "p50_latency_seconds": 0.018,
            "p95_latency_seconds": 0.11,
            "max_latency_seconds": 12.0,
          },
          "diagnostic": {
            "requests": 40,
            "requests_per_second": 0.1333,
            "in_window_server_errors": 0,
            "in_window_client_errors": 0,
            "server_error_rate": 0.0,
            "p50_latency_seconds": 0.012,
            "p95_latency_seconds": 0.074,
    ...
    "rollouts": {
      ...
      "error": None,
      "sources": {
        "deployments": {"available": True, "error": None, "collection_ms": 2.1, "count": 1},
        "daemonsets": {"available": True, "error": None, "collection_ms": 1.8, "count": 0},
        "statefulsets": {"available": True, "error": None, "collection_ms": 1.7, "count": 1},
        "jobs": {"available": True, "error": None, "collection_ms": 2.4, "count": 1},
      },
      "summary": {
        "total": 3,
        "state_counts": {"healthy": 2, "failed": 1},
        "kind_counts": {"Deployment": 1, "StatefulSet": 1, "Job": 1},
        "problem_count": 1,
      },
      "items": [
        {
...
def demo_health() -> dict:
  return {
    ...
    "checks": [
      ...
      {
        "id": "visibility.rollouts",
        "group": "Visibility",
        "label": "Workload controllers",
        "status": "ok",
        "detail": "3 workload controllers · 1 degraded or failed",
      },
      {
    ...
    "stats": [
      ...
      {
        "id": "gateway.http_requests",
        "label": "Gateway requests",
        "value": "124",
        "value_number": 124,
        "unit": "requests",
        "detail": "last 5m · 3 in flight",
        "context": {
          "window_seconds": 300,
          "requests_per_second": 0.4133,
          "in_flight": 3,
          ...
          "dropped_samples": 0,
          "window_truncated": False,
          "group_requests": {"application": 124, "background": 84, "diagnostic": 40},
        },
        "status": "ok",
      },
      {
        "id": "gateway.http_latency",
        "label": "Gateway p95 latency",
        "value": "420.0 ms",
        "value_number": 420,
        "unit": "milliseconds",
        "detail": "p50 83.0 ms · max 3.8 s",
        "context": {
          "requests": 124,
          "p50_latency_seconds": 0.083,
          "p95_latency_seconds": 0.42,
      ...
      {
        "id": "gateway.http_errors",
        "label": "Gateway server errors",
        "value": "2",
        "value_number": 2,
        "unit": "errors",
        "detail": "1.6% of application requests",
        "context": {"requests": 124, "server_error_rate": 0.0161, "client_errors": 1, "recent_errors": []},
        "status": "warn",
      },
      {
        "id": "redis.memory",
      ...
      },
      {
        ...
        "label": "Kubernetes rollouts",
        "value": "1/3 issues",
        "value_number": 1,
        "unit": "controllers",
        "detail": "1 failed · 2 healthy",
        "context": {"total": 3, "state_counts": {"healthy": 2, "failed": 1}, "kind_counts": {"Deployment": 1, "StatefulSet": 1, "Job": 1}},
        "status": "warn",
      },
    ],
    "queues": [
